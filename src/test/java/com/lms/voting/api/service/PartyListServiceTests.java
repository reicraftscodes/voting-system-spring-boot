...
//import com.lms.voting.api.service.imp.PartyListServiceImpl;
...
//        List<String> result = partyListServiceImp.getAllPartyMembers();
//        assertEquals(2, result.size());
//        assertEquals("Labour", result.get(0));
//        assertEquals("Conservative", result.get(1));
//
